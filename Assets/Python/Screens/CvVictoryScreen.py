...
class CvVictoryScreen:
	...
	def __init__(self):
		...
		#TKs
		self.TABLE_WIDTH_6 = 180
		self.TABLE_WIDTH_7 = 100
		#Tke
	...
	def interfaceScreen(self):
		...
		screen.addDDSGFC(self.BACKGROUND_ID, ArtFileMgr.getInterfaceArtInfo("TK_MAINMENU_SLIDESHOW_LOAD").getPath(), 0, 0, self.W_SCREEN, self.H_SCREEN, WidgetTypes.WIDGET_GENERAL, -1, -1 )
	...
	def showVictoryConditionScreen(self):
		...
		#TKs
		screen.addTableControlGFC(szTable, 8, self.X_AREA, self.Y_AREA, self.W_AREA, self.H_AREA, False, False, 32,32, TableStyles.TABLE_STYLE_STANDARD)
		...
		screen.setTableColumnHeader(szTable, 6, "", self.TABLE_WIDTH_6)
		screen.setTableColumnHeader(szTable, 7, "", self.TABLE_WIDTH_7)
