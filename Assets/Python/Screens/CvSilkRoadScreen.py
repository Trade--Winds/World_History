...
class CvSilkRoadScreen:
	...
	def getScreen(self):
		return CyGInterfaceScreen("EuropeScreen", CvScreenEnums.SILK_ROAD_SCREEN)
	...
	def interfaceScreen(self):
		...
		screen.addDDSGFC("EuropeScreenBackground", ArtFileMgr.getInterfaceArtInfo("INTERFACE_SILK_ROAD_BACKGROUND").getPath(), 0, 0, self.XResolution, self.YResolution, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC("TopPanel", ArtFileMgr.getInterfaceArtInfo("INTERFACE_SILK_ROAD_TITLE_BAR").getPath(), 0, 0, self.XResolution, 55, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		screen.addDDSGFC("BottomPanel", ArtFileMgr.getInterfaceArtInfo("INTERFACE_SILK_ROAD_TAB_OFF").getPath(), 0, self.YResolution - 55, self.XResolution, 55, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		...
		# Header...
		#TKs Med
		screen.setLabel("EuropeScreenWidgetHeader", "Background", u"<font=4b>" + localText.getText("TXT_KEY_SILK_ROAD_SCREEN_TITLE", ()).upper() + u"</font>", CvUtil.FONT_CENTER_JUSTIFY, self.XResolution / 2, self.Y_TITLE, 0, FontTypes.TITLE_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
		...
		ThisScreen = self.TRADE_SCREEN_SILK_ROAD_MARKET 
...
#				#Androrc End
		...
		for iYield in YieldList:
			...
			if (kYield.isMilitary()):
				...
				if not (pPlayer.canUnitBeTraded(iYield, self.TRADE_SCREEN_SILK_ROAD_MARKET, UnitTypes.NO_UNIT)):
				...
				elif not (pPlayer.canUnitBeTraded(iYield, self.TRADE_SCREEN_SILK_ROAD_MARKET, UnitTypes.NO_UNIT)):
