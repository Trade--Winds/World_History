		...
		for iOptionLoop in range(PlayerOptionTypes.NUM_PLAYEROPTION_TYPES):
			...
			if (iOptionLoop == PlayerOptionTypes.PLAYEROPTION_MODDER_1):
				...
				if (gc.getDefineINT("USE_MODDERS_PLAYEROPTION_3") == 0):
					bContinue = false
			elif (iOptionLoop == PlayerOptionTypes.PLAYEROPTION_MODDER_4):
				if (gc.getDefineINT("USE_MODDERS_PLAYEROPTION_4") == 0):
					bContinue = false
			elif (iOptionLoop == PlayerOptionTypes.PLAYEROPTION_MODDER_5):
				if (gc.getDefineINT("USE_MODDERS_PLAYEROPTION_5") == 0):
					bContinue = false
			elif (iOptionLoop == PlayerOptionTypes.PLAYEROPTION_MODDER_6):
				if (gc.getDefineINT("USE_MODDERS_PLAYEROPTION_6") == 0):
					bContinue = false
