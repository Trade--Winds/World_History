...
# Place random stuff on map END
	...
	def onCombatLogHit(self, argsList):
		...
		if (iIsAttacker == 0):
			if (iEffect == 1):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_HIT_CRUSHING", (szDefenderName, cdDefender.sUnitName, iDamage, cdDefender.iCurrHitPoints, cdDefender.iMaxHitPoints))
			elif (iEffect == 2):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_HIT_GLANCING", (szDefenderName, cdDefender.sUnitName, iDamage, cdDefender.iCurrHitPoints, cdDefender.iMaxHitPoints))
			elif (iEffect == 3):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_BLOCK", (szDefenderName, cdDefender.sUnitName, iDamage, cdDefender.iCurrHitPoints, cdDefender.iMaxHitPoints))
			elif (iEffect == 4):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_FIRSTSTRIKE", (szDefenderName, cdDefender.sUnitName, iDamage, cdDefender.iCurrHitPoints, cdDefender.iMaxHitPoints))
			else:
			...
			if (iEffect == 1):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_HIT_CRUSHING", (szAttackerName, cdAttacker.sUnitName, iDamage, cdAttacker.iCurrHitPoints, cdAttacker.iMaxHitPoints))
			elif (iEffect == 2):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_HIT_GLANCING", (szAttackerName, cdAttacker.sUnitName, iDamage, cdAttacker.iCurrHitPoints, cdAttacker.iMaxHitPoints))
			elif (iEffect == 3):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_BLOCK", (szAttackerName, cdAttacker.sUnitName, iDamage, cdAttacker.iCurrHitPoints, cdAttacker.iMaxHitPoints))
			elif (iEffect == 4):
				combatMessage = localText.getText("TXT_KEY_COMBAT_MESSAGE_FIRSTSTRIKE", (szAttackerName, cdAttacker.sUnitName, iDamage, cdAttacker.iCurrHitPoints, cdAttacker.iMaxHitPoints))
			else:
