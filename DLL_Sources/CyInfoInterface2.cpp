...
void CyInfoPythonInterface2()
{
	...
	python::class_<CvCivilizationInfo, python::bases<CvInfoBase> >("CvCivilizationInfo")
		...
		///TKs MEd
		.def("getAdjectiveKey", &CvCivilizationInfo::pyGetAdjectiveKey, "wstring ()")
		///Tke
	...
	python::class_<CvHandicapInfo, python::bases<CvInfoBase> >("CvHandicapInfo")
		...
		// < JAnimals Mod Start >
		//.def("getAIAnimalLandStartDistance", &CvHandicapInfo::getAIAnimalLandStartDistance, "int ()")
		//.def("getAIAnimalSeaStartDistance", &CvHandicapInfo::getAIAnimalSeaStartDistance, "int ()")
