...
public:
    ...
    DllExport int getRehibilitateUnitClass() const;
    DllExport int getLaborForceUnitClass() const;
    DllExport int getConvertsToGold() const;
    DllExport int getTradeBonus() const;
    DllExport int getKnightDubbingWeight() const;
    DllExport int getCasteAttribute() const;
	///TKe
	...
	bool getFeatureNative(int iIndex) const;
	bool getBonusNative(int iIndex) const;
	// < JAnimals Mod End >
...
protected:
	...
	int m_iConvertsToYield;
	int m_iConvertsToBuildingClass;
	int m_iFreeBuildingClass;
	int m_iEducationUnitClass;
	int m_iRehibilitateUnitClass;
	int m_iLaborForceUnitClass;
	int m_iConvertsToGold;
	int m_iTradeBonus;
	int m_iKnightDubbingWeight;
	int m_iCasteAttribute;
	///Tke
...
public:
	...
	DllExport int getInventionCategory() const;
	DllExport int getRequiredInvention() const;
	DllExport int getRequiredInvention2() const;
	DllExport int getRequiredInventionOr() const;
    DllExport int getRequiredUnitType() const;

	DllExport int getX_Location() const;
	...
	DllExport int getIncreasedImmigrants() const;
	DllExport int getFreeTechs() const;
	DllExport int getModdersCode1() const;
	...
	DllExport bool isAllowsMapTrade() const;
    ...
    DllExport int getAllowsBuildingTypes(int i) const;
    DllExport int getConvertsUnitsTo() const;
    DllExport int getConvertsUnitsFrom() const;
    DllExport int getAllowsUnitClasses(int i) const;
...
protected:
	...
	///TKs Invention Core Mod v 1.0
	int m_iInventionCategory;
	int m_iRequiredInvention;
	int m_iRequiredInvention2;
	int m_iRequiredInventionOr;
    int m_iRequiredUnitType;

    //int m_iRequiredYield;
	int m_iX_Location;
	int m_iY_Location;
    ...
    int m_iIncreaseCityPopulation;
    int m_aiConvertsUnitsTo;
    ...
    int* m_aiAllowsYields;
    int* m_aiAllowsBonuses;
    int* m_aiAllowsPromotions;
...
public:
	...
	///TKs Med
	DllExport int getBuildingMakesInvalid() const;
	DllExport int getAlternateBuilding() const;
	DllExport int getCityType() const;
	...
	DllExport bool isArmory() const;
	DllExport int getAutoSellYieldChange() const;
...
protected:
	...
	///Tks Med
	int m_iBuildingMakesInvalid;
	int m_iAlternateBuilding;
	int m_iCityType;
	...
	///TKs Med
    int* m_aiMaxYieldModifiers;
    int* m_aiImmigrationUnits;
    int* m_aiAutoSellsYields;
	///Tke
...
public:
	...
	///TKs Invention Core Mod v 1.0
	DllExport int getCivilizationTechs(int i) const;
	///TKe
...
public:
	...
	// < JAnimals Mod Start >
	//int getAIAnimalLandStartDistance() const;
	//int getAIAnimalSeaStartDistance() const;
...
protected:
	...
	// < JAnimals Mod Start >
	//int m_iAIAnimalLandStartDistance;
	//int m_iAIAnimalSeaStartDistance;
...
public:
	...
	///TKd Med
	DllExport bool isGoodyTechs() const;
	///TKe
...
public:
	...
	///TKs Med
	DllExport bool isArmor() const;
	DllExport int getLatitude() const;
	DllExport int getLatitudeModifiers() const;
	DllExport bool isMustBeDiscovered() const;
...
public:
    ...
    std::wstring pyGetAttackForceKey() { return getAttackForceKey(); }

    DllExport const wchar* getDeclareKey() const;
    std::wstring pyGetDeclareKey() { return getDeclareKey(); }

    DllExport const wchar* getDawnKey() const;
    std::wstring pyGetDawnKey() { return getDawnKey(); }
	///Tke
...
protected:
	...
	///TKs Med
    int iVictoryType;
    int iTravelCommandType;
    int iEconomyType;
    bool m_bWaterStart;
    CvWString m_szAttackForceKey;
    CvWString m_szDeclareKey;
    CvWString m_szDawnKey;
    ///Tke
	int m_iBaseAttitude;
...
public:
	...
	DllExport bool isFreePromotionsAllowChange() const;
	DllExport bool isFreeBuildingAllowChange() const;
	///TKe
...
protected:
	...
	///TKs Med
	bool* m_abFreePromotionUnitClass;
	bool* m_abFreePromotionUnitProfession;
	///TKe
...
public:
	...
	///TKs Med
	DllExport int getPreInvention() const;
	DllExport int getPreBuilding() const;
	DllExport int getYieldProduced() const;
	DllExport int getExpertProfessionBonus() const;
	///Tke
	DllExport bool read(CvXMLLoadUtility* pXML);
