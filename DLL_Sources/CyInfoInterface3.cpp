...
///TKs Invention Core Mod v 1.0 Aymerics changes are here
void CyInfoPythonInterface3()
{
	...
	python::class_<CvYieldInfo, python::bases<CvInfoBase> >("CvYieldInfo")
		...
		///Tks Med
		.def("isMustBeDiscovered", &CvYieldInfo::isMustBeDiscovered, "bool ()")
		.def("isArmor", &CvYieldInfo::isArmor, "bool ()")
		.def("isMilitary", &CvYieldInfo::isMilitary, "bool ()")
		///Tke
		;
	...
	python::class_<CvLeaderHeadInfo, python::bases<CvInfoBase> >("CvLeaderHeadInfo")
		...
		///TKs Med
		.def("getTravelCommandType", &CvLeaderHeadInfo::getTravelCommandType, "int ()")
		.def("getEconomyType", &CvLeaderHeadInfo::getEconomyType, "int ()")
		.def("getVictoryType", &CvLeaderHeadInfo::getVictoryType, "int ()")
		///TKe
		// Arrays
	...
	python::class_<CvSeaLevelInfo, python::bases<CvInfoBase> >("CvSeaLevelInfo")
		...
		;
	python::class_<CvEuropeInfo, python::bases<CvInfoBase> >("CvEuropeInfo")
	...
	python::class_<CvEraInfo, python::bases<CvInfoBase> >("CvEraInfo")
		...
		// < JAnimals Mod Start >
		.def("isNoAILandAnimals", &CvEraInfo::isNoAILandAnimals, "bool () -")
		.def("isNoAISeaAnimals", &CvEraInfo::isNoAISeaAnimals, "bool () -")
		// < JAnimals Mod End >
		// Arrays
	...
	python::class_<CvMainMenuInfo, python::bases<CvInfoBase> >("CvMainMenuInfo")
		...
		;
	python::class_<CvProfessionInfo, python::bases<CvInfoBase> >("CvProfessionInfo")
		...
		.def("getArtTagUnitClass", &CvProfessionInfo::getArtTagUnitClass, "int ()")
		.def("isNativesInvalid", &CvProfessionInfo::isNativesInvalid, "bool ()")
		.def("isEuropeInvalid", &CvProfessionInfo::isEuropeInvalid, "bool ()")
		.def("isColonialInvalid", &CvProfessionInfo::isColonialInvalid, "bool ()")
		.def("getArtTagUnitClass", &CvProfessionInfo::getArtTagUnitClass, "int ()")
		///TKe
		...
		.def("getYieldsConsumedPedia", &CvProfessionInfo::getYieldsConsumedPedia, "int (int)")
	...
	python::class_<CvFatherInfo, python::bases<CvInfoBase> >("CvFatherInfo")
		...
		///TK Med
		.def("getCivic", &CvFatherInfo::getCivic, "int ()")
		///TKe
		...
		;
	python::class_<CvFatherPointInfo, python::bases<CvInfoBase> >("CvFatherInfo")
		...
		;
	python::class_<CvAlarmInfo, python::bases<CvInfoBase> >("CvAlarmInfo")
