...
public:
	...
	///Tks Med
	bool isHasBuildingClass(int /*BuildingClassTypes*/ iIndex);
	//Tke
...
///TKs Med
	int getBaseRawYieldProduced(int /*YieldTypes*/ eIndex, int /*SpecialBuildingTypes*/ eSpecialBuilding);
	///TKe
	...
	///TKs Med
	int calculateActualYieldProduced(int /*YieldTypes*/ eYield, int /*SpecialBuildingTypes*/ eSpecialBuilding) const;
	///TKe
	...
	///Tks Med
	int getMaxYieldCapacity(int /*YieldTypes*/ eYield);

	int getMaxYieldCapacityPer(int /*YieldTypes*/ eYield);
	///TKe
