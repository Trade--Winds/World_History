...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		///TKs Med
		.def("isHasBuildingClass", &CyCity::isHasBuildingClass, "bool (int iBuildingID)")
		//TKe
        ...
        ///TKs Med
		.def("getBaseRawYieldProduced", &CyCity::getBaseRawYieldProduced, "int (int /*YieldTypes*/, int /*SpecialBuildingTypes*/)  - Yield Bonus produced in all cities")
		///TKe
		...
		///TKs Med
		.def("calculateActualYieldProduced", &CyCity::calculateActualYieldProduced, "int (int /*YieldTypes*/, int /*SpecialBuildingTypes*/")
		///TKe
		...
		///Tks Med
		.def("getMaxYieldCapacity", &CyCity::getMaxYieldCapacity, "int /*YieldType*/()")
		.def("getMaxYieldCapacityPer", &CyCity::getMaxYieldCapacityPer, "int /*YieldType*/()")
		.def("getSelectedArmor", &CyCity::getSelectedArmor, "int /*ProfessionType*/()")
		.def("getMaxCityPop", &CyCity::getMaxCityPop, "int()")
		.def("getCityType", &CyCity::getCityType, "int()")
		///TKe
