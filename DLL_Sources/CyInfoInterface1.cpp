...
void CyInfoPythonInterface1()
{
	...
	python::class_<CvUnitInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvUnitInfo")
		...
		.def("isNativesInvalid", &CvUnitInfo::isNativesInvalid, "bool ()")
		.def("isEuropeInvalid", &CvUnitInfo::isEuropeInvalid, "bool ()")
		.def("isColonialInvalid", &CvUnitInfo::isColonialInvalid, "bool ()")
		///TKe
		...
		.def("getFeatureNative", &CvUnitInfo::getFeatureNative, "bool (int iIndex)")
		.def("getBonusNative", &CvUnitInfo::getBonusNative, "bool (int iIndex)")
		// < JAnimals Mod End >
...
//		.def("getArtDefineTag", &CvUnitInfo::getArtDefineTag, "string (int i)")
	...
	python::class_<CvCivicInfo, python::bases<CvInfoBase> >("CvCivicInfo")
		...
		///TKs Invention Core Mod v 1.0
		.def("getRequiredUnitType", &CvCivicInfo::getRequiredUnitType, "int ()")
		.def("getCivicPortrait", &CvCivicInfo::getCivicPortrait, "string ()")
		.def("getInventionCategory", &CvCivicInfo::getInventionCategory, "int ()")
		.def("getRequiredFatherPoints", &CvCivicInfo::getRequiredFatherPoints, "int ()")
		.def("getProlificInventorRateChange", &CvCivicInfo::getProlificInventorRateChange, "int ()")
		.def("getRequiredInvention", &CvCivicInfo::getRequiredInvention, "int ()")
		.def("getRequiredInvention2", &CvCivicInfo::getRequiredInvention2, "int ()")
		.def("getRequiredInventionOr", &CvCivicInfo::getRequiredInventionOr, "int ()")
		.def("getX_Location", &CvCivicInfo::getX_Location, "int ()")
		.def("getY_Location", &CvCivicInfo::getY_Location, "int ()")
	...
	python::class_<CvBuildingInfo, python::bases<CvInfoBase, CvScalableInfo> >("CvBuildingInfo")
		...
		///TKs Med
		.def("getBuildingMakesInvalid", &CvBuildingInfo::getBuildingMakesInvalid, "int ()")
		.def("getAlternateBuilding", &CvBuildingInfo::getAlternateBuilding, "int ()")
		.def("isArmory", &CvBuildingInfo::isArmory, "bool ()")
		///TKe
		...
		.def("getOverflowSellPercent", &CvBuildingInfo::getOverflowSellPercent, "int ()")
