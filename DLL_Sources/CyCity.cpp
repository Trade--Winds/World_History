...
///TKs Med
bool CyCity::isHasBuildingClass(int /*BuildingTypes*/ iIndex)
{
...
int CyCity::getBaseRawYieldProduced(int /*YieldTypes*/ eIndex, int /*SpecialBuildingTypes*/ eSpecialBuilding)
{
	return m_pCity ? m_pCity->getBaseRawYieldProduced((YieldTypes)eIndex, (SpecialBuildingTypes)eSpecialBuilding) : -1;
}
...
///TKs Med
int CyCity::calculateActualYieldProduced(int /*YieldTypes*/ eYield, int /*SpecialBuildingTypes*/ eSpecialBuilding) const
{
	return m_pCity ? m_pCity->calculateActualYieldProduced((YieldTypes)eYield, (SpecialBuildingTypes)eSpecialBuilding) : -1;
}
///TKe
...
///TKs Med
int CyCity::getMaxYieldCapacity(int /*YieldTypes*/ eYield)
{
	return (m_pCity ? m_pCity->getMaxYieldCapacity((YieldTypes) eYield) : -1);
}

int CyCity::getMaxYieldCapacityPer(int /*YieldTypes*/ eYield)
{
	return (m_pCity ? m_pCity->getMaxYieldCapacityPer((YieldTypes) eYield) : -1);
}
///Tke
...
{
	return m_pCity ? m_pCity->getSelectedArmor() : -1;
}

int CyCity::getCityType()
{
	return m_pCity ? m_pCity->getCityType() : 0;
}

int CyCity::getMaxCityPop()
{
	return m_pCity ? m_pCity->getMaxCityPop() : GC.getDefineINT("MAX_CITY_POPULATION_VILLAGE");
}
///Tke
