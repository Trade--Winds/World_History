...
public:
	...
	///TKs Med
	void AI_pilgramMove();
	bool AI_moveTowardsPilgramCity();
	bool AI_maraudTowardsVictimCity();
	void AI_doFound(int iType);
	void AI_MarauderMove();
	///TKe
...
protected:
    ...
    bool AI_getTributeColony(int iMinAttitude, int iMaxAttitude, int iRange);
   ///TKs Med Return Home
