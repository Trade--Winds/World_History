...
void CyPlayerPythonInterface2(python::class_<CyPlayer>& x)
{
	...
	x
		...
		///TKs Med
		.def("getYieldSellPrice", &CyPlayer::getYieldSellPrice, "int (eYield), int (eTradeScreen)")
		.def("getYieldBuyPrice", &CyPlayer::getYieldBuyPrice, "int (eYield), int (eTradeScreen)")
		///TKe
