...
private:
	...
	bool launchChooseInventionPopup(CvPopup* pPopup, CvPopupInfo &info);
		//TK Tax
	bool launchTaxAdvisorPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchRansomKnightPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchArmorsmithPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchMarketPopup(CvPopup* pPopup, CvPopupInfo &info);
	bool launchNoblesJoinPopup(CvPopup* pPopup, CvPopupInfo &info);
	//TKe
    ///Tks Return Home
