...
public:
	...
	bool canMakeVassalDemand(int /*PlayerTypes*/ eVassal);
	int getVassalOwner() const;
	...
	int getIdeaProgress(int /*CivicTypes*/ eCivic);
	int getCensureType(int /*CensureType*/ eCensure);
	int getCostToResearch(int /*CivicTypes*/ eCivic);
