...
public:
    ...
    ///TKs Med
	DllExport void createVassalPlayer(PlayerTypes eVassalOwner = NO_PLAYER, CvCity* pCity = NULL);
	///Tke
	...
	bool testVictory(VictoryTypes eVictory, TeamTypes eTeam, bool* pbEndScore = NULL);
...
protected:
	...
	// < JAnimals Mod Start >
	PlayerTypes m_eBarbarianPlayer;
	// < JAnimals Mod End >
	TeamTypes m_eWinner;
