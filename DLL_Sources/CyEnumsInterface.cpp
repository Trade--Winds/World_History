...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		///TKs Med TradeRoutes
		.value("WIDGET_TRADE_SCREEN_ROUTE", WIDGET_TRADE_SCREEN_ROUTE)
		.value("WIDGET_AUTO_TRADE_SCREEN", WIDGET_AUTO_TRADE_SCREEN)
		.value("WIDGET_POP_UP_SCREEN", WIDGET_POP_UP_SCREEN)
	...
	python::enum_<YieldTypes>("YieldTypes")
		...
		.value("YIELD_FOOD",                  YIELD_NUTRIENTS)
		.value("YIELD_LUMBER",                YIELD_BIOPOLYMERS)
		.value("YIELD_STONE",                 YIELD_SILICATES)
		.value("YIELD_ORE",                   YIELD_BASE_METALS)
		.value("YIELD_ACTINIDES",             YIELD_ACTINIDES)
		.value("YIELD_ISOTOPES",              YIELD_ISOTOPES)
		.value("YIELD_RARE_EARTHS",           YIELD_RARE_EARTHS)
		.value("YIELD_CRYSTALLOIDS",          YIELD_CRYSTALLOIDS)
		.value("YIELD_NUCLEIC_ACIDS",         YIELD_NUCLEIC_ACIDS)
		...
		.value("YIELD_DATACORES",             YIELD_DATACORES)
		...
		.value("YIELD_CLATHRATES",            YIELD_CLATHRATES)
		.value("YIELD_CORE_SAMPLES",          YIELD_CORE_SAMPLES)
		.value("YIELD_TOOLS",                 YIELD_MACHINE_TOOLS)
		.value("YIELD_HORSES",                YIELD_ROBOTICS)
		.value("YIELD_WEAPONS",               YIELD_MUNITIONS)
		.value("YIELD_PHOTONICS",             YIELD_PHOTONICS)
		.value("YIELD_PLASTEEL",              YIELD_PLASTEEL)
		.value("YIELD_DURALLOY",              YIELD_DURALLOY)
		.value("YIELD_CRYSTALLOY",            YIELD_CRYSTALLOY)
		.value("YIELD_NUCLEONICS",            YIELD_NUCLEONICS)
		.value("YIELD_FUSION_CORES",          YIELD_FUSION_CORES)
		.value("YIELD_SEMICONDUCTORS",        YIELD_SEMICONDUCTORS)
		.value("YIELD_PLASMIDS",              YIELD_PLASMIDS)
		.value("YIELD_ENZYMES",               YIELD_ENZYMES)
		.value("YIELD_STEM_CELLS",            YIELD_STEM_CELLS)
		.value("YIELD_STATE_SECRETS",         YIELD_STATE_SECRETS)
		.value("YIELD_PROGENITOR_TECH",       YIELD_PROGENITOR_TECH)
		.value("YIELD_ALIEN_RELICS",          YIELD_ALIEN_RELICS)
		.value("YIELD_NARCOTICS",             YIELD_NARCOTICS)
		.value("YIELD_BIOWEAPONS",            YIELD_BIOWEAPONS)
		.value("YIELD_PHARMACEUTICALS",       YIELD_PHARMACEUTICALS)
		.value("YIELD_PETROCHEMICALS",        YIELD_PETROCHEMICALS)
		.value("YIELD_COLLOIDS",              YIELD_COLLOIDS)
		.value("YIELD_CATALYSTS",             YIELD_CATALYSTS)
		.value("YIELD_HARD_CURRENCY",         YIELD_HARD_CURRENCY)
		.value("YIELD_TRADE_GOODS",           YIELD_EARTH_GOODS)
		.value("YIELD_CONTRABAND",            YIELD_CONTRABAND)
		.value("YIELD_EARTHLING_SPECIMENS",   YIELD_EARTHLING_SPECIMENS)
		.value("YIELD_HAMMERS",               YIELD_INDUSTRY)
		.value("YIELD_CROSSES",               YIELD_MEDIA)
		.value("YIELD_BELLS",                 YIELD_LIBERTY)
		.value("YIELD_IDEAS",                 YIELD_RESEARCH)
		.value("YIELD_EDUCATION",             YIELD_EDUCATION)
		.value("YIELD_CULTURE",               YIELD_INFLUENCE)
		.value("YIELD_ENERGY",                YIELD_ENERGY)
		.value("YIELD_POLLUTANTS",            YIELD_POLLUTANTS)
		.value("YIELD_GOLD",                  YIELD_CREDITS)
#endif
		.value("YIELD_FROM_ANIMALS",          YIELD_FROM_ANIMALS)
		.value("YIELD_DEFAULT_ARMOR_TYPE",    YIELD_DEFAULT_ARMOR_TYPE)
