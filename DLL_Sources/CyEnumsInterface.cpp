...
//		.value("YIELD_PORCELAIN", YIELD_PORCELAIN)
    ...
    python::enum_<TradeScreenTypes>("TradeScreenTypes")
     ...
     python::enum_<ModCodeTypes>("ModCodeTypes")
		...
		.value("FASTER_CHOP_TREES", FASTER_CHOP_TREES)
		.value("SPICE_ROUTE", SPICE_ROUTE)
		.value("SILK_ROAD_ROUTE", SILK_ROAD_ROUTE)
		.value("TRADING_POST", TRADING_POST)
		.value("ONLY_NONE_NATIVES", ONLY_NONE_NATIVES)
		.value("NATIVES_ONLY", NATIVES_ONLY)
		.value("ANYONE", ANYONE)
		.value("NATIVES_VIKING_AGE", NATIVES_VIKING_AGE)
		.value("ALLOWS_TRADE_FAIR", ALLOWS_TRADE_FAIR)
		.value("CANNOT_WORK_BUILDINGS", CANNOT_WORK_BUILDINGS)
		.value("NONE_MILITARY", NONE_MILITARY)
		.value("UNIT_SQUIRE", UNIT_SQUIRE)
		.value("UNIT_CRAFTMEN_NOBLES", UNIT_CRAFTMEN_NOBLES)
		.value("UNIT_AI_ONLY", UNIT_AI_ONLY)
		.value("CANNOT_LEARN_NATIVE", CANNOT_LEARN_NATIVE)
